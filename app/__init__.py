...
def create_app():
    ...
    from .views import main_views, sensor_views, login_views, time_table_views, introduce_views, temp_views, cleaning_views
    ...
    app.register_blueprint(cleaning_views.bp)
